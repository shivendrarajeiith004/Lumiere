...
MAIN_FNCTN_RETURN_STATEMENT : RETURN VALUE SEMICOLON {};
CONSOLE_STATEMENT : CONSOLE LEFT_PARENT STRING RIGHT_PARENT SEMICOLON {};

INCLUDE_TYPE_STATEMENT : HASH INCLUDE LESS_THAN LIBRARY GREATER_THAN  {};
                       ;
MAIN_FUNCTION_STATMENT : INT FUNCTION LEFT_PARENT RIGHT_PARENT LEFT_CURLY_BRACE CMPD_STATEMENT RIGHT_CURLY_BRACE {};

CONNECT_TO_FUNCTION_STATEMENT : IDENTIFIER JOIN_OPERATOR CONNECT_TO LEFT_PARENT IDENTIFIER RIGHT_PARENT SEMICOLON {};
...
VAR_LIST :  VAR_LIST COMMA VAR {
         ...
         |VAR {
                ...
                $$[1] = "\0";  // NULL-terminate the list
                  ...
                  ;
VAR_TYPE : INT_TYPE {printf("Here"); $$ = INTEGER_ENUM; }
...
ASSIGN_OP : ASSIGN   {$$ = ASSIGN_ENUM;}
          ...
          | DIVIDE_COMPOUND_ASSIGNMENT {$$=DIV_CMPND_ENUM;}CONDITIONAL_STATEMENT: IF_STATEMENT {}
                     | IF_STATEMENT ELSE_STATEMENT {}
                     | IF_STATEMENT ELSEIF_STATEMENT_LIST ELSE_STATEMENT {};
/* STATEMENTS */
IF_STATEMENT:IF LEFT_PARENT RELATIONAL_EXP RIGHT_PARENT LEFT_CURLY_BRACE CMPD_STATEMENT RIGHT_CURLY_BRACE ;

ELSE_STATEMENT: ELSE LEFT_CURLY_BRACE CMPD_STATEMENT RIGHT_CURLY_BRACE;
ELSEIF_STATEMENT_LIST: ELSEIF_STATEMENT ELSEIF_STATEMENT_LIST | ELSEIF_STATEMENT;
ELSEIF_STATEMENT: ELSE_IF LEFT_PARENT RELATIONAL_EXP RIGHT_PARENT LEFT_CURLY_BRACE CMPD_STATEMENT RIGHT_CURLY_BRACE;
%%
