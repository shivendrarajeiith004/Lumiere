...
IF_STATEMENT:IF LEFT_PAREN BOOLEAN_EXP RIGHT_PAREN LEFT_CURLY_BRACE STATEMENT RIGHT_CURLY_BRACE {printf("IF STATEMENT");};

ELSE_STATEMENT: ELSE LEFT_CURLY_BRACE STATEMENT RIGHT_CURLY_BRACE;

ELSEIF_STATEMENT: ELSE_IF LEFT_PAREN BOOLEAN_EXP RIGHT_PAREN LEFT_CURLY_BRACE STATEMENT RIGHT_CURLY_BRACE;

*/           
EXPRESSION : BOOLEAN_EXP  EOL{printf("Relations here\n");}
           ;
