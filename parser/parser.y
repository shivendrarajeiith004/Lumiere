...
%%
STATEMENT_MAIN: CONDITIONAL_STATEMENT EOL;
...
BOOLEAN_EXP: BOOL_VALUE;
STATEMENT: INT VAR  ;
IF_STATEMENT:IF LEFT_PAREN BOOLEAN_EXP RIGHT_PAREN LEFT_CURLY_BRACE STATEMENT RIGHT_CURLY_BRACE;
